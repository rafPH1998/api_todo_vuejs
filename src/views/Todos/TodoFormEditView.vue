    ...
    <div class="px-3 py-10 md:px-10">
        <div class="w-full sm:w-1/2 lg:w-1/3 mx-auto">
            <div v-show="todos.showMsgSuccess" 
                ...
                <span class="font-medium">Sucesso!</span> Tarefa editada com sucesso!
            </div>
            ...
            <form @submit.prevent="editTodo()" action="#" method="POST">
                <div class="w-full">
                    <div class="relative flex items-center justify-center z-0 mb-6 w-full group">
                        <input type="text" name="title" id="title" 
                            ...
                            <label for="title" 
                                ...
                                peer-focus:scale-75 peer-focus:-translate-y-6">Edite a sua tarefa
                            </label>
                    </div>
                </div>
                ...
                <button :disabled="todos.loading"
                        ...
                        <span v-if="todos.loading">Editando...</span>
    ...
    setup (props) {
        ...
        onMounted(async () => {
            ...
            TodoService.getTodo(props.id)
                        .then((response) => {
                            const todosReponse = response.data.data
                           
                            todos.title = todosReponse.title
                            todos.completed = todosReponse.completed == 'S'
                        })
        ...
        const editTodo = () => {
            ...
            TodoService.editTodo(props.id, {...todos})
                        .then((response) => {
